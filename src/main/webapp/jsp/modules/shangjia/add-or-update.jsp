							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>商家账号</label>
										<input name="shangjiazhanghao" id="shangjiazhanghao" name="shangjiazhanghao" class="form-control" placeholder="商家账号">
									</div>
									<div class="form-group col-md-6">
										<label>商家姓名</label>
										<input name="shangjiaxingming" id="shangjiaxingming" name="shangjiaxingming" class="form-control" placeholder="商家姓名">
									</div>
									<div class="form-group col-md-6">
										<label>密码</label>
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.shangjiaxingming != null && res.data.shangjiaxingming != ''){
						...
						$("#shangjiaxingming").attr('readonly','readonly');
					}
