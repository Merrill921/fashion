...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="shangjiazhanghaoSearch" class="form-control form-control-sm" placeholder="请输入商家账号" aria-controls="tableId">
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#shangjiazhanghaoSearch').val() != null && $('#shangjiazhanghaoSearch').val() != ''){
				searchForm.shangjiazhanghao ="%" +  $('#shangjiazhanghaoSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("shangjia/page","GET",{
				...
				sort: sortColumn,
				order: sortOrder,
				shangjiazhanghao : searchForm.shangjiazhanghao,	
			},(res)=>{
				if(res.code == 0){
					clear();
