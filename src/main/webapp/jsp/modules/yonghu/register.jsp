...
<style>
	...
	body {
		...
		width: 100%;
		height: 100%;
						background-image: url(http://codegen.caihongy.cn/20210725/81b9a52864364a408eb233abd5370398.jpg) !important;
					}
	.container {
		padding: 0;
		margin: 0;
	...
	#login-wrapper {
		...
		box-shadow: 10px 8px 6px rgba(11,11,11,1);
	}
	...
	#login-wrapper h1 {
		...
		box-shadow: -0px 6px 8px rgba(11, 11, 11,1);
		text-align: center;
	}
