					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑服装类型</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">服装类型信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
									<div class="form-group col-md-6">
										<label>服装类型</label>
										<input name="fuzhuangleixing" id="fuzhuangleixing" name="fuzhuangleixing" class="form-control" placeholder="服装类型">
									</div>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "fuzhuangleixing/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("fuzhuangleixing/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("fuzhuangleixing/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("fuzhuangleixing/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dataBind(){
			...
			$("#fuzhuangleixing").val(ruleForm.fuzhuangleixing);	
		}		
		//图片显示
		function showImg(){
		}		
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.fuzhuangleixing != null && res.data.fuzhuangleixing != ''){
						...
						$("#fuzhuangleixing").val(res.data.fuzhuangleixing);
						$("#fuzhuangleixing").attr('readonly','readonly');
					}
				}
			});  
            }
