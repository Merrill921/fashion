			...
			<div :style='{"display": "flex","justify-content": "center","padding":"20px"}'>
				...
				<div v-if="queryIndex==0" class="item-list">
					<input type="text" :style='{"boxShadow":"0 0 6px rgba(255,0,0,0)","borderColor":"rgba(236, 111, 102, 1)","backgroundColor":"rgba(245, 245, 245, 1)","color":"#333","borderRadius":"8px","textAlign":"center","borderWidth":"1px","width":"140px","fontSize":"14px","borderStyle":"solid","height":"44px"}'
					 name="fuzhuangshangchengfuzhuangmingcheng" id="fuzhuangshangchengfuzhuangmingcheng" placeholder="服装名称" autocomplete="off" class="layui-input">
				</div>
				<button v-if="queryIndex==0" :style='{"padding":"0 15px","boxShadow":"0 0 8px rgba(0,0,0,0)","margin":"0 0 0 10px","borderColor":"#409EFF","backgroundColor":"rgba(236, 111, 102, 1)","color":"#fff","borderRadius":"4px","borderWidth":"0","width":"auto","fontSize":"14px","borderStyle":"solid","height":"40px"}'
				 id="btn-search" @click="jump('../fuzhuangshangcheng/list.jsp')" type="button" class="layui-btn layui-btn-normal">
				...
				<div class="news index-pv2" style="display: flex;justify-content: center;width:100%" :style='{"padding":"10px 0 10px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0","borderColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","background":"transparent url(http://codegen.caihongy.cn/20220304/97f906ed6551446da37fcb6a851c3e69.png) no-repeat top","borderStyle":"solid"}'>
				  <div class="box" style='width:60%'>
				    ...
				    <div class="title" :style='{"padding":"10px 0 10px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0 0 40px 0","borderColor":"rgba(0,0,0,1)","backgroundColor":"rgba(247, 247, 247, 0)","color":"rgba(0, 0, 0, 1)","borderRadius":"0","alignItems":"center","borderWidth":"0","fontSize":"20px","borderStyle":"solid"}'>
				      <span>HOME NEWS</span><span>服装资讯</span>
				    </div>
				...
				<div class="recommend index-pv3" :style='{"padding":"10px 0 10px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0","borderColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","background":"transparent url(http://codegen.caihongy.cn/20220304/580e6f02e0bb4b96a27f36216b300c82.png) no-repeat top","borderStyle":"solid"}'>
					<div class="box" style='width:80%'>
						...
						<div class="title" :style='{"isshow":true,"padding":"10px 0 10px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"40px 0 -50px 0","borderColor":"rgba(0,0,0,1)","backgroundColor":"rgba(247, 247, 247, 0)","color":"rgba(0, 0, 0, 1)","borderRadius":"0","alignItems":"center","borderWidth":"0","fontSize":"20px","borderStyle":"solid"}'>
							<span>DATA SHOW</span><span>服装商城展示</span>
						</div>
					...
					<div class="list-4">
					    <div class="list-4-body-left" style="display: flex;flex-direction: column;transform: none !important">
							<div class="list-4-body" style="display: flex;flex-direction: row;">
										<div v-if="fuzhuangshangchengList.length>0" @click="jump('../fuzhuangshangcheng/detail.jsp?id='+fuzhuangshangchengList[0].id)" class="list-4-item animation-box item-1" :style='{"padding":"0","boxShadow":"0 0 0px rgba(0,0,0, .3)","margin":"0 20px 20px 0","borderColor":"#ccc","backgroundColor":"rgba(204, 204, 204, 0)","borderRadius":"0","borderWidth":"0","width":"370px","borderStyle":"solid","height":"260px"}'>
										  <img :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"#ccc","borderRadius":"10px","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}' :src="fuzhuangshangchengList[0].fuzhuangtupian?baseurl+fuzhuangshangchengList[0].fuzhuangtupian.split(',')[0]:''" alt="" />
										  <div :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(0, 0, 0, 0.5)","borderRadius":"0 0 10px 10px","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}' v-if="true" class="list-4-item-center">
											<div  class="line1" :style='{"padding":"0 6px","boxShadow":"0 0 0px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(0,0,0,0)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"44px","fontSize":"14px","borderStyle":"solid"}' class="list-4-item-title">{{fuzhuangshangchengList[0].fuzhuangmingcheng}}</div>
										  </div>
										</div>
										<div v-if="fuzhuangshangchengList.length>1" @click="jump('../fuzhuangshangcheng/detail.jsp?id='+fuzhuangshangchengList[1].id)" class="list-4-item animation-box item-2" :style='{"padding":"0","boxShadow":"0 0 0px rgba(0,0,0, .3)","margin":"0 20px 20px 0","borderColor":"#ccc","backgroundColor":"rgba(204, 204, 204, 0)","borderRadius":"0","borderWidth":"0","width":"370px","borderStyle":"solid","height":"320px"}'>
										  <img :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"#ccc","borderRadius":"10px","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}' :src="fuzhuangshangchengList[1].fuzhuangtupian?baseurl+fuzhuangshangchengList[1].fuzhuangtupian.split(',')[0]:''" alt="" />
										  <div :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(0, 0, 0, 0.5)","borderRadius":"0 0 10px 10px","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}' v-if="true" class="list-4-item-center">
											<div  class="line1" :style='{"padding":"0 6px","boxShadow":"0 0 0px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(0,0,0,0)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"44px","fontSize":"14px","borderStyle":"solid"}' class="list-4-item-title">{{fuzhuangshangchengList[1].fuzhuangmingcheng}}</div>
										  </div>
										</div>
							</div>
							<div v-if="fuzhuangshangchengList.length>2" @click="jump('../fuzhuangshangcheng/detail.jsp?id='+fuzhuangshangchengList[2].id)" class="list-4-item animation-box item-3" :style='{"padding":"0","boxShadow":"0 0 0px rgba(0,0,0, .3)","margin":"0 20px 0 0","borderColor":"#ccc","backgroundColor":"rgba(204, 204, 204, 0)","borderRadius":"0","borderWidth":"0","width":"752px","borderStyle":"solid","height":"240px"}'>
							  <img :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"#ccc","borderRadius":"10px","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}' :src="fuzhuangshangchengList[2].fuzhuangtupian?baseurl+fuzhuangshangchengList[2].fuzhuangtupian.split(',')[0]:''" alt="" />
							  <div :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(0, 0, 0, 0.5)","borderRadius":"0 0 10px 10px","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}' v-if="true" class="list-4-item-center">
								<div  class="line1" :style='{"padding":"0 6px","boxShadow":"0 0 0px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(0,0,0,0)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"44px","fontSize":"14px","borderStyle":"solid"}' class="list-4-item-title">{{fuzhuangshangchengList[2].fuzhuangmingcheng}}</div>
							  </div>
							</div>
						</div>
					    <div class="list-4-body">
					    			<div v-if="fuzhuangshangchengList.length>3" @click="jump('../fuzhuangshangcheng/detail.jsp?id='+fuzhuangshangchengList[3].id)" class="list-4-item animation-box item-4" :style='{"padding":"0","boxShadow":"0 0 0px rgba(0,0,0, .3)","margin":"0 20px 20px 0","borderColor":"#ccc","backgroundColor":"rgba(204, 204, 204, 0)","borderRadius":"0","borderWidth":"0","width":"230px","borderStyle":"solid","height":"380px"}'>
					    			  <img :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"#ccc","borderRadius":"10px","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}' :src="fuzhuangshangchengList[3].fuzhuangtupian?baseurl+fuzhuangshangchengList[3].fuzhuangtupian.split(',')[0]:''" alt="" />
					    			  <div :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(0, 0, 0, 0.5)","borderRadius":"0 0 10px 10px","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}' v-if="true" class="list-4-item-center">
					    			  	<div  class="line1" :style='{"padding":"0 6px","boxShadow":"0 0 0px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(0,0,0,0)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"44px","fontSize":"14px","borderStyle":"solid"}' class="list-4-item-title">{{fuzhuangshangchengList[3].fuzhuangmingcheng}}</div>
					    			  </div>
					    			</div>
					    			<div v-if="fuzhuangshangchengList.length>4" @click="jump('../fuzhuangshangcheng/detail.jsp?id='+fuzhuangshangchengList[4].id)" class="list-4-item animation-box item-5" :style='{"padding":"0","boxShadow":"0 0 0px rgba(0,0,0, .3)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(204, 204, 204, 0)","borderRadius":"0","borderWidth":"0","width":"230px","borderStyle":"solid","height":"177px"}'>
					    			  <img :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"#ccc","borderRadius":"10px","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}' :src="fuzhuangshangchengList[4].fuzhuangtupian?baseurl+fuzhuangshangchengList[4].fuzhuangtupian.split(',')[0]:''" alt="" />
					    			  <div :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(0, 0, 0, 0.5)","borderRadius":"0 0 10px 10px","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}' v-if="true" class="list-4-item-center">
					    			  	<div  class="line1" :style='{"padding":"0 6px","boxShadow":"0 0 0px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(0,0,0,0)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"44px","fontSize":"14px","borderStyle":"solid"}' class="list-4-item-title">{{fuzhuangshangchengList[4].fuzhuangmingcheng}}</div>
					    			  </div>
					    			</div>
					    </div>
					</div>
					<div class="clear"></div>
					<div style="text-align: center;">
					<button @click="jump('../fuzhuangshangcheng/list.jsp')" style="display: block;cursor: pointer;" type="button" :style='{"padding":"0 20px","boxShadow":"4px -4px 0px #EC6F66","margin":"20px auto","borderColor":"#ccc","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","borderRadius":"20px","borderWidth":"1px","width":"auto","fontSize":"14px","borderStyle":"solid","height":"34px"}'>查看更多<i v-if="false" :style='{"isshow":false,"padding":"0 0 0 1px","fontSize":"14px","color":"rgba(110,22,64,1)"}' class="layui-icon layui-icon-next"></i></el-button>
					</div>
		...
		<script>
			var vue = new Vue({
				...
				methods: {
					...
					if (this.queryIndex == 0) {
						localStorage.setItem('indexQueryCondition', document.getElementById("fuzhuangshangchengfuzhuangmingcheng").value);
					}
						jump(url)
					},
					queryChange(event) {
						...
						if (this.queryIndex == 0) {
							this.fuzhuangshangchengfuzhuangmingcheng = this.queryList[event.target.value].queryName;
						}
					}
				}
			})
			...
			layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function() {
                ...
                http.request(`fuzhuangshangcheng/list`, 'get', {
					...
					vue.fuzhuangshangchengList = res.data.list
					let flag = 8;
					let options = {"navigation":{"nextEl":".swiper-button-next","prevEl":".swiper-button-prev"},"slidesPerView":5,"loop":true,"spaceBetween":20,"autoplay":{"delay":3000,"disableOnInteraction":false}}
					options.pagination = {el:'null'}
					if(options.slidesPerView) {
					...
					if(flag == 3) {
						vue.$nextTick(() => {
							new Swiper ('#listsfuzhuangshangcheng', options)
						})
					}
					// 商品列表样式五
					if(flag == 5) {
						vue.$nextTick(() => {
							var swiper = new Swiper('#lists-five-swiperfuzhuangshangcheng', {
								loop: true,
								speed: 500,
