				...
				<div class="right-container" :style='{"padding":"20px","boxShadow":"0px 0px 0px rgba(110,22,64,.8)","margin":"0","borderColor":"rgba(110,22,64,.3)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0","borderStyle":"solid"}'>
					<form style="margin-top: 20px;" class="layui-form" lay-filter="myForm">
						<div :style='{"padding":"10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0 0 10px 0","borderColor":"rgba(110,22,64,.3)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0","borderStyle":"solid"}' class="layui-form-item layui-form-text">
							<label :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"14px","color":"rgba(0, 0, 0, 1)","textAlign":"right"}' class="layui-form-label">联系人：</label>
						...
						<div :style='{"padding":"10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0 0 10px 0","borderColor":"rgba(110,22,64,.3)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0","borderStyle":"solid"}' class="layui-form-item layui-form-text l-redio">
							<label :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"14px","color":"rgba(0, 0, 0, 1)","textAlign":"right"}' class="layui-form-label">默认地址：</label>
						...
						<div class="layui-form-item">
							<div class="layui-input-block"  style="display: flex;flex-wrap:wrap;">
								<button style="outline:none" :style='{"padding":"0 10px","boxShadow":"4px -4px 0px #EC6F66","margin":"10px ","borderColor":"rgba(243, 161, 131, 1)","backgroundColor":"rgba(255, 255, 255, 1)","color":"rgba(0, 0, 0, 1)","borderRadius":"0","borderWidth":"4px 1px 1px","width":"10%","fontSize":"14px","borderStyle":"dashed solid solid","height":"44px"}' class="layui-btn btn-submit" lay-submit lay-filter="*">添加</button>
								<button style="outline:none" :style='{"padding":"0 10px","boxShadow":"4px -4px 0 #ABABAB","margin":"10px ","borderColor":"rgba(194, 194, 194, 1)","backgroundColor":"rgba(255, 255, 255, 1)","color":"rgba(171, 171, 171, 1)","borderRadius":"0","borderWidth":"4px 1px 1px ","width":"10%","fontSize":"14px","borderStyle":"dashed solid solid","height":"44px"}' type="reset" class="layui-btn layui-btn-primary">重置</button>
							</div>
						</div>
					</form>
				</div>
