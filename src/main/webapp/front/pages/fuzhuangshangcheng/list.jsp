			...
			<div class="recommend index-pv1" :style='{"padding":"10px 0 10px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0","borderColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","background":"transparent","borderStyle":"solid"}'>
				<div class="box" style='width:80%'>
					...
					<form class="layui-form filter" :style='{"padding":"0 10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"10px 0 10px 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(0, 0, 0, 0)","borderRadius":"4px","borderWidth":"0","borderStyle":"solid","justifyContent":"flex-end","height":"64px"}'>
						...
						<div class="item-list">
							<div class="lable" :style='{"padding":"0 10px","boxShadow":"0 0 0px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(255, 255, 255, 0)","color":"rgba(0, 0, 0, 1)","borderRadius":"0","textAlign":"right","borderWidth":"0","width":"auto","fontSize":"16px","borderStyle":"solid"}'>服装名称</div>
							<input type="text" :style='{"boxShadow":"0 0 6px rgba(255,0,0,0)","borderColor":"rgba(236, 111, 102, 1)","backgroundColor":"rgba(245, 245, 245, 1)","color":"#333","borderRadius":"8px","textAlign":"center","borderWidth":"1px","width":"140px","fontSize":"14px","borderStyle":"solid","height":"44px"}' name="fuzhuangmingcheng" id="fuzhuangmingcheng" placeholder="服装名称" autocomplete="off" class="layui-input">
						</div>
					<div class="item-list">
						<div class="lable" :style='{"padding":"0 10px","boxShadow":"0 0 0px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(255, 255, 255, 0)","color":"rgba(0, 0, 0, 1)","borderRadius":"0","textAlign":"right","borderWidth":"0","width":"auto","fontSize":"16px","borderStyle":"solid"}'>服装类型</div>
						<select :style='{"boxShadow":"0 0 6px rgba(255,0,0,0)","borderColor":"rgba(236, 111, 102, 1)","backgroundColor":"rgba(245, 245, 245, 1)","color":"#333","borderRadius":"8px","textAlign":"center","borderWidth":"1px","width":"140px","fontSize":"14px","borderStyle":"solid","height":"44px"}' style="display:block" name="fuzhuangleixing" id="fuzhuangleixing" lay-filter="fuzhuangleixing">
							<option value="">请选择</option>
							<option v-for="(item,index) in fuzhuangleixingOptions" v-bind:key="index" :value="item">{{item}}</option>
						</select>
					</div>
						<div class="item-list">
							<div class="lable" :style='{"padding":"0 10px","boxShadow":"0 0 0px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(255, 255, 255, 0)","color":"rgba(0, 0, 0, 1)","borderRadius":"0","textAlign":"right","borderWidth":"0","width":"auto","fontSize":"16px","borderStyle":"solid"}'>服装颜色</div>
							<input type="text" :style='{"boxShadow":"0 0 6px rgba(255,0,0,0)","borderColor":"rgba(236, 111, 102, 1)","backgroundColor":"rgba(245, 245, 245, 1)","color":"#333","borderRadius":"8px","textAlign":"center","borderWidth":"1px","width":"140px","fontSize":"14px","borderStyle":"solid","height":"44px"}' name="fuzhuangyanse" id="fuzhuangyanse" placeholder="服装颜色" autocomplete="off" class="layui-input">
						</div>
						<div class="item-list">
							<div class="lable" :style='{"padding":"0 10px","boxShadow":"0 0 0px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(255, 255, 255, 0)","color":"rgba(0, 0, 0, 1)","borderRadius":"0","textAlign":"right","borderWidth":"0","width":"auto","fontSize":"16px","borderStyle":"solid"}'>服装材料</div>
							<input type="text" :style='{"boxShadow":"0 0 6px rgba(255,0,0,0)","borderColor":"rgba(236, 111, 102, 1)","backgroundColor":"rgba(245, 245, 245, 1)","color":"#333","borderRadius":"8px","textAlign":"center","borderWidth":"1px","width":"140px","fontSize":"14px","borderStyle":"solid","height":"44px"}' name="fuzhuangcailiao" id="fuzhuangcailiao" placeholder="服装材料" autocomplete="off" class="layui-input">
						</div>
						...
						<div class="list" style="position: relative;">
							<div @click="jump('../fuzhuangshangcheng/detail.jsp?id='+item.id)" v-for="(item,index) in dataList" :key="index" class="list-item" :class="4=='3'?'list-item3':4=='5'?'list-item5':''">
								<div class="list-item-body animation-box" :style='{"padding":"20px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0 0 10px 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(249, 249, 249, 1)","borderRadius":"0 20px 20px 0","borderWidth":"0","borderStyle":"solid"}'>
									<img :style='{"boxShadow":"0 0 0px rgba(110,22,64,.8)","borderColor":"rgba(243, 161, 131, 1)","borderRadius":"0 30px 30px 0","borderWidth":"4px","width":"90%","borderStyle":"solid","height":"330px"}' :src="item.fuzhuangtupian?baseurl+item.fuzhuangtupian.split(',')[0]:''">
									<div class="info">
										...
										<div v-if="true" :style='{"isshow":true,"padding":"0","margin":"10px 0 0 0","backgroundColor":"rgba(0,0,0,0)","color":"rgba(0, 0, 0, 1)","borderRadius":"0","textAlign":"center","width":"100%","fontSize":"16px"}' class="name">{{item.fuzhuangmingcheng}}</div>
									</div>
								</div>
							</div>
						</div>
			...
			var vue = new Vue({
				...
				data: {
					...
					swiperList: [{
				        ...
				        fuzhuangleixingOptions: [],
				        fuzhuangchimaOptions: [],
			...
			layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery','laydate'], function() {
				...
				http.request('config/list', 'get', {
        			...
        			http.request(`option/fuzhuangleixing/fuzhuangleixing`,'get',{},(res)=>{
                			vue.fuzhuangleixingOptions = res.data
        			});
			        vue.fuzhuangchimaOptions = 'S,M,L,XL,XXL'.split(',')
        			http.request(`option/shangjia/shangjiazhanghao`,'get',{},(res)=>{
                			vue.shangjiazhanghaoOptions = res.data
        			});
				...
				function pageList() {
			        ...
			        if (jquery('#fuzhuangmingcheng').val()) {
			          param['fuzhuangmingcheng'] = jquery('#fuzhuangmingcheng').val() ? '%' + jquery('#fuzhuangmingcheng').val() + '%' : '';
			        }
			        if (jquery('#fuzhuangleixing').val()) {
			          param['fuzhuangleixing'] = jquery('#fuzhuangleixing').val() ? jquery('#fuzhuangleixing').val() : '';
			        }
			        if (jquery('#fuzhuangyanse').val()) {
			          param['fuzhuangyanse'] = jquery('#fuzhuangyanse').val() ? '%' + jquery('#fuzhuangyanse').val() + '%' : '';
			        }
			        if (jquery('#fuzhuangcailiao').val()) {
			          param['fuzhuangcailiao'] = jquery('#fuzhuangcailiao').val() ? '%' + jquery('#fuzhuangcailiao').val() + '%' : '';
			        }
				...
				if (indexQueryCondition) {
					param['fuzhuangmingcheng'] = '%' + indexQueryCondition + '%';
					localStorage.removeItem('indexQueryCondition');
				}
					// 获取列表数据
					http.request('fuzhuangshangcheng/list', 'get', param, function(res) {
